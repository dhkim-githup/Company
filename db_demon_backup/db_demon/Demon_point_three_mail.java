...
class  Demon_point_three_mail
{
		static private comm.DB_Use_Db_Demon  db ;  //  DB 연결하는 빈즈
        //생성자
        public Demon_point_three_mail(){}
        ...
        public static void main(String[] args)
        {
        	...
        	try{
            	...
            	db.CUST_ID = "00002345";
            	db.PROG_NM = "/user/home/mro/mro_demon/Demon_point_three_mail.java";
    			db.DB_Conn();
				System.out.println("Db Connection !! ");
				// Call Procedure
				db.prepareCall("{call P_SPEED_DEMON.F_GET_POINT_THREE_YEAR_MAIL(?,?)}");
