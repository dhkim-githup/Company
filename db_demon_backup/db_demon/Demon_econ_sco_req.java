...
public class Demon_econ_sco_req {
	...
	public void run(String sUrl){
        ...
        if(sUrl == null || "".equals(sUrl)){
        	sUrl = "http://localhost/econScoReqBatch.do";
			...
			if(!osName.startsWith("Windows")){
				...
				sUrl = "http://172.16.1.183/econScoReqBatch.do";
			}
        }
...
//            printByInputStream(urlConnection.getInputStream());
	...
	public static void main(String[] args) {
		...
		System.out.println("-------------Start Econ Sco Req-------------");
		log.Write(log_flag, prgm_nm, "-------------Start Econ Sco Req-------------");

		String sUrl = "";
		sUrl = args.length > 0 ? "".equals(args[0]) ? "" : args[0] : "";
		
		Demon_econ_sco_req demon = new Demon_econ_sco_req();
		
		demon.run(sUrl);
		
		log.Write(log_flag, prgm_nm, "-------------End Econ Sco Req-------------");
		System.out.println("-------------End Econ Sco Req-------------");
	}
