...
public class MROK_0092_PurchActReqRcvLocator extends org.apache.axis.client.Service implements com.mrok.schema.MROKGW.EPR.MROK_0092_PurchActReqRcv.MROK_0092_PurchActReqRcv {
    ...
    private java.lang.String MROK_0092_PurchActReqRcvSoap_address = "http://210.211.67.201/MROK_WS_PRD/MROK_0092_PurchActReqRcv/MROK_0092_PurchActReqRcv.asmx";
    ...
    // Use to get a proxy class for MROK_0092_PurchActReqRcvSoap12
    private java.lang.String MROK_0092_PurchActReqRcvSoap12_address = "http://210.211.67.201/MROK_WS_PRD/MROK_0092_PurchActReqRcv/MROK_0092_PurchActReqRcv.asmx";

    public java.lang.String getMROK_0092_PurchActReqRcvSoap12Address() {
        return MROK_0092_PurchActReqRcvSoap12_address;
    }

    // The WSDD service name defaults to the port name.
    private java.lang.String MROK_0092_PurchActReqRcvSoap12WSDDServiceName = "MROK_0092_PurchActReqRcvSoap12";

    public java.lang.String getMROK_0092_PurchActReqRcvSoap12WSDDServiceName() {
        return MROK_0092_PurchActReqRcvSoap12WSDDServiceName;
    }

    public void setMROK_0092_PurchActReqRcvSoap12WSDDServiceName(java.lang.String name) {
        MROK_0092_PurchActReqRcvSoap12WSDDServiceName = name;
    }

    public com.mrok.schema.MROKGW.EPR.MROK_0092_PurchActReqRcv.MROK_0092_PurchActReqRcvSoap getMROK_0092_PurchActReqRcvSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
            endpoint = new java.net.URL(MROK_0092_PurchActReqRcvSoap12_address);
        }
        catch (java.net.MalformedURLException e) {
            throw new javax.xml.rpc.ServiceException(e);
        }
        return getMROK_0092_PurchActReqRcvSoap12(endpoint);
    }

    public com.mrok.schema.MROKGW.EPR.MROK_0092_PurchActReqRcv.MROK_0092_PurchActReqRcvSoap getMROK_0092_PurchActReqRcvSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.mrok.schema.MROKGW.EPR.MROK_0092_PurchActReqRcv.MROK_0092_PurchActReqRcvSoap12Stub _stub = new com.mrok.schema.MROKGW.EPR.MROK_0092_PurchActReqRcv.MROK_0092_PurchActReqRcvSoap12Stub(portAddress, this);
            _stub.setPortName(getMROK_0092_PurchActReqRcvSoap12WSDDServiceName());
            return _stub;
        }
        catch (org.apache.axis.AxisFault e) {
            return null;
    ...
    public void setMROK_0092_PurchActReqRcvSoap12EndpointAddress(java.lang.String address) {
        MROK_0092_PurchActReqRcvSoap12_address = address;
    }
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            ...
            if (com.mrok.schema.MROKGW.EPR.MROK_0092_PurchActReqRcv.MROK_0092_PurchActReqRcvSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.mrok.schema.MROKGW.EPR.MROK_0092_PurchActReqRcv.MROK_0092_PurchActReqRcvSoap12Stub _stub = new com.mrok.schema.MROKGW.EPR.MROK_0092_PurchActReqRcv.MROK_0092_PurchActReqRcvSoap12Stub(new java.net.URL(MROK_0092_PurchActReqRcvSoap12_address), this);
                _stub.setPortName(getMROK_0092_PurchActReqRcvSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        else if ("MROK_0092_PurchActReqRcvSoap12".equals(inputPortName)) {
            return getMROK_0092_PurchActReqRcvSoap12();
        }
        else  {
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://schema.mrok.com/MROKGW/EPR/MROK_0092_PurchActReqRcv", "MROK_0092_PurchActReqRcvSoap12"));
        }
...
if ("MROK_0092_PurchActReqRcvSoap12".equals(portName)) {
            setMROK_0092_PurchActReqRcvSoap12EndpointAddress(address);
        }
        else 
{ // Unknown Port Name
