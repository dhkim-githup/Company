...
//	private static final String dbURL="jdbc:oracle:thin:@172.16.1.202:1521:ORA8";
	...
	*/
	...
	/* 행복나래 운영디비 */ 
	public String dbURL="jdbc:oracle:thin:@172.16.1.17:1521:ORA11GCN";
	public String user_id="METS_CN";
	public String user_pw="METS131010CN"; 	
	...
	public Connection DB_Conn() {
		 ...
		 try {
				log(PROG_NM+": Connection Before !!");
				Class.forName(driver);
				Class.forName("oracle.jdbc.driver.OracleDriver");
				conn=DriverManager.getConnection(dbURL,user_id,user_pw);
				log(PROG_NM+": Connection After !!");
	            conn.setAutoCommit(false);

			} catch (ClassNotFoundException e) {
				ERR_FLAG = -1; ERR_CODE = -1; conn = null;
				log(PROG_NM,"ERR ConnectionBean: driver unavailable !!");
			} catch (Exception e) {
				ERR_FLAG = -1; ERR_CODE = -1; conn = null;
				log(PROG_NM,"ERR ConnectionBean: driver not loaded !!");
			}
			return conn;
		}	
	...
	public void executeQuery(String sql) throws SQLException {
        ...
        try {
			...
			log(PROG_NM,CUST_ID+">>=>DB_ERR_MSG="+ERR_MSG+" ==> "+sql);
		} catch (Exception e) {
			ERR_FLAG = -1; ERR_MSG = e.toString(); ERR_CODE = -1000;
			log(PROG_NM,CUST_ID+">>=>ERR =>"+ERR_MSG);
		}
	}
	...
	public int executeUpdate(String sql) throws SQLException {
		...
		int res = 0;
		try {
			log(dml_qry_log,PROG_NM,CUST_ID+">>=>DB_SURE="+sql);
	...
	public void PsetString(int seq,String p_val) {
		...
		try {
			...
			ERR_FLAG = -1; ERR_CODE = e.getErrorCode(); ERR_MSG = e.toString();
			System.out.println(">>=>DB_ERR_MSG="+ERR_MSG+" ==> "+msg_buf11+msg_buf21);
		}
	}
	...
	public void PexecuteQuery() throws SQLException {
		ERR_FLAG = 0; ERR_CODE = 0;
		try {
			log(sel_qry_log,PROG_NM,CUST_ID+">>=>DB_SURE= "+msg_buf11+msg_buf21);
			prs = ps.executeQuery();
		} catch (SQLException e) {
			ERR_FLAG = -1; ERR_CODE = e.getErrorCode(); ERR_MSG = e.toString();
			System.out.println(">>=>DB_ERR_MSG="+ERR_MSG+" ==> "+msg_buf11+msg_buf21);
	...
	public int PexecuteUpdate() throws SQLException {
		...
		int res = 0;
		try {
			log(dml_qry_log,PROG_NM,CUST_ID+">>=>DB_SUER= "+msg_buf11+msg_buf21);
	...
	public void prepareStatement2(String sql) throws SQLException {
		...
		try {
			...
			ERR_FLAG = -1; ERR_CODE = e.getErrorCode(); ERR_MSG = e.toString();
			System.out.println(">>=>DB_ERR_MSG="+ERR_MSG+"==> "+sql);
		}
	}
	...
	public void PsetString2(int seq,String p_val) {
		...
		try {
			...
			ERR_FLAG = -1; ERR_CODE = e.getErrorCode(); ERR_MSG = e.toString();
			System.out.println(">>=>DB_ERR_MSG="+ERR_MSG+"==> "+msg_ps21+msg_ps22);
		}
	}
	...
	public void PexecuteQuery2() throws SQLException {
		ERR_FLAG = 0; ERR_CODE = 0;
		try {
			log(sel_qry_log,PROG_NM,CUST_ID+">>=>DB_SUER= "+msg_ps21+msg_ps22);
	...
	public int PexecuteUpdate2() throws SQLException {
		...
		int res = 0;
		try {
			log(dml_qry_log,PROG_NM,CUST_ID+">>=>DB_SUER= "+msg_ps21+msg_ps22);
	...
	public void prepareStatement3(String sql) throws SQLException {
		...
		try {
			...
			ERR_FLAG = -1; ERR_MSG = e.toString(); ERR_CODE = e.getErrorCode();
			System.out.println(">>=>DB_ERR= "+sql+" -- "+ERR_MSG);
		}
	}
	...
	public void PsetString3(int seq,String p_val) {
		...
		try {
			...
			ERR_FLAG = -1; ERR_MSG = e.toString(); ERR_CODE = e.getErrorCode();
			System.out.println(">>=>DB_ERR= "+msg_ps31+msg_ps32+" -- "+ERR_MSG);
		}
	}
	...
	public void PexecuteQuery3() throws SQLException {
		ERR_FLAG = 0; ERR_CODE = 0;
		try {
			log(sel_qry_log,PROG_NM,CUST_ID+">>=>DB_SUER= "+msg_ps31+msg_ps32);
	...
	public int PexecuteUpdate3() throws SQLException {
		...
		int res = 0;
		try {
			log(dml_qry_log,PROG_NM,CUST_ID+">>=>DB_SUER= "+msg_ps31+msg_ps32);
	...
	public void CsetString(int seq,String p_val) {
		...
		try {
			...
			ERR_FLAG = -1; ERR_MSG = e.toString(); ERR_CODE = e.getErrorCode();
			System.out.println(">>=>DB_ERR= "+msg_buf1+msg_buf2+" -- "+ERR_MSG);
		}
	}
	...
	public int Cexecute() throws SQLException {
		ERR_FLAG = 0; ERR_CODE = 0;
		try {
			System.out.println(">>=>DB_SUER= "+msg_buf1+msg_buf2);
			cs.execute();
		} catch (SQLException e) {
			ERR_FLAG = -1; ERR_MSG = e.toString(); ERR_CODE = e.getErrorCode();
			System.out.println(">>=>DB_ERR= "+msg_buf1+msg_buf2+" -- "+ERR_MSG);
	...
	public void CsetString2(int seq,String p_val) {
		...
		try {
			...
			ERR_FLAG = -1; ERR_MSG = e.toString(); ERR_CODE = e.getErrorCode();
			System.out.println(">>=>DB_ERR= "+cs_msg21+cs_msg22+" -- "+ERR_MSG);
		}
	}
	...
	public int Cexecute2() throws SQLException {
		ERR_FLAG = 0; ERR_CODE = 0;
		try {
			System.out.println(">>=>DB_SUER= "+cs_msg21+cs_msg22);
			cs2.execute();
		} catch (SQLException e) {
			ERR_FLAG = -1; ERR_MSG = e.toString(); ERR_CODE = e.getErrorCode();
			System.out.println(">>=>DB_ERR= "+cs_msg21+cs_msg22+" -- "+ERR_MSG);
	...
	public void DB_DisConn() {
		try {
			...
			log(PROG_NM, "############ DisConnect  Connection Beans - DB_Use DisConnetc Ver.1 ##############");
			log(PROG_NM, "[■ DB DisConnect Ver.2]");
		} catch (Exception e) { }
	}

	public void log(String p_val) { System.out.println(p_val); }
	public void log(String p_pgnm, String p_val) { System.out.println(p_pgnm+" : "+p_val); }
	public void log(int p_yn, String p_val) { if(p_yn > 0) System.out.println(p_val); }	
	public void log(int p_yn, String p_pgnm, String p_val) { if(p_yn > 0) System.out.println(p_pgnm+" : "+p_val); }	
