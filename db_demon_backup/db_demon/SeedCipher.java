 ...
 * @version stable_5.0
 * @author naonsoft
 * @deprecated com.naon.framework.util 패키지에 있는 클래스를 사용하거나 클래스 생성.
 * 
 */
public class SeedCipher {
	...
	public byte[] decrypt(byte[] encryptBytes, byte[] szKey) {
		...
		SeedEncRoundKey(sRoundKey, szKey);
		//for (int i=0;i<sRoundKey.length;i++) {
		//	this.logger.debug(Integer.toHexString(sRoundKey[i]));
		//}
