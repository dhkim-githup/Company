...
/*
   ...
   SELECT '1COMP' gbn                                                                                
         ...
         ,td.exch                                                                                    
         ,od.acep_man                                                                                
         ,(SELECT MAX(TO_CHAR(y.tx_acco_dati, 'yyyymmdd'))                                           
    ...
    WHERE 1=1                                                                                        
      ...
      AND td.comp_dati_happy IS NULL                                                                 
      AND nvl(td.comp_kn,'---') <> 'ACC'                                                             
   ...
   SELECT '1COMP' gbn                                                                                
    ...
    WHERE 1=1                                                                                        
      ...
      AND cd.enpri_cd = ed.enpri_cd                                                                  
      AND cd.busip_seq = ed.busip_seq                                                                
      AND ei.enpri_cd IN ('A43773','A44160','A51698')                                                
      AND ( od.cust_ord_num LIKE '4500%'  OR                                                         
            (ei.enpri_cd IN ('A43773') AND  od.cust_ord_num IS NULL ) )                              
      AND od.ords_kn IN ('003','005','013','015')                                                    
      AND NVL(od.asp_flag,'002') <> '001'                                                            
   ...
   SELECT '2ASP' gbn                                                                                 
         ...
         ,(SELECT x.db_user FROM enpri_info x                                                        
            WHERE x.enpri_cd = ed.enpri_cd) db_user                                                  
   ...
   SELECT '3BACK' gbn                                                                                
    ...
    WHERE 1=1                                                                                        
      ...
      AND A.comp_kn = 'ACC'                                                                          
      AND A.comp_dati_cust >= TO_DATE('20130101','yyyy-mm-dd')                                       
...
public class  Demon_asp_comp_20m
{
        ...
        public static void main(String[] args)
        {
			...
			String sDemonLog = "  INSERT INTO demon_list_14(reg_dati, prog_nm, memo, reg_day, status , err_msg)  "
        	...
        	try{
    			...
    			/*
    			log.Write(log_flag, prgm_nm, "select asp db users!!");
				...
				*/
    			...
    			sbSelList.append("      AND A.comp_dati_cust >= TO_DATE('20130101','yyyy-mm-dd')                                         ").append("\n");
				...
				sDemonLog = "  INSERT INTO demon_list_14(reg_dati, prog_nm, memo, reg_day, status , err_msg)  "
