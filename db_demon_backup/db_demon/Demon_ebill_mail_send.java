...
public class Demon_ebill_mail_send {
...
//            printByInputStream(urlConnection.getInputStream());
	...
	public static void main(String[] args) {
		...
		log.Write(log_flag, prgm_nm, "-------------Start ebillMailSend-------------");

		String sUrl = "";
		sUrl = args.length > 0 ? "".equals(args[0]) ? "" : args[0] : "";

		Demon_ebill_mail_send demon = new Demon_ebill_mail_send();
		demon.checkAlive(sUrl);
		
		log.Write(log_flag, prgm_nm, "-------------End ebillMailSend-------------");
