...
//	private static final String dbURL="jdbc:oracle:thin:@172.16.1.202:1521:ORA8";
	...
	private Statement smt= null, smt2 = null, smt3 = null, ex_smt = null;
	...
	public Connection DB_Conn() {
	 ...
	 try {
			/*
			if("mets".equals(user_id)){
				Driver myDriver = (Driver)Class.forName("jeus.jdbc.pool.Driver").newInstance();
				conn = myDriver.connect("jdbc:jeus:pool:mroPool", null);
				System.out.println("::::: mroPool : " + conn);
			}else{
			*/
