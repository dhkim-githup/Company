...
public class mk_log {
	...
	private static String dir = "/user/home/mro/Err_log/";	//로그 화일이 저장될 디렉토리.
	private static String filename;      					// 로그화일이름.
	private static String errfile ;         				// Error가 발생한 화일이름.
